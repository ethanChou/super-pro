...
public class SimpleServer extends Thread {
	...
	public static void main(String[] args) {
		...
		SimpleServer listener = new SimpleServer(sel);
		listener.run();
	}
	...
	public SimpleServer(Selector sel) {
		this.sel = sel;
	}
	...
	// static void test() {
	// Message message = new Message(2, 1, (byte) 0, (byte) 0, new byte[] { 1,
	// 1, 1, 1, 2, 2, 2, 2 });
